...
$lang['usefscache']  = 'Cache LDAP user data on disk to speed up recurring queries. The maximum cache age is bound by the global <code>auth_security_timeout</code> setting.';
